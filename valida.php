 ...
 * @license   https://www.pasosdejesus.org/dominio_publico_colombia.html Dominio P�blico. Sin garant�ass
...
resValida(
    $db, "Casos con m�s de una ubicaci�n (salen duplicados en conteos)",
...
resValida(
    $db, "V�ctimas con categorias que no son para v�ctimas individuales",
...
resValida(
    $db, "V�ctimas colectivas con categorias que no son para v�ctimas colectivas",
...
resValida(
    $db, _("Registros en victima_colectiva que no est�n en actocolectivo"),
