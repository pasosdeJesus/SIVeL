...
$aut_usuario = "";
$db = autenticaUsuario($dsn, $accno, $aut_usuario, 62);
...
$ni = $db->getOne($s);
sin_error_pear($ni);
echo " Se insertar�n " . (int)$ni . " actos<br>";
hace_consulta(
...
$ni = $db->getOne($s);
sin_error_pear($ni);
echo " Se insertar�n " . (int)$ni . " actos colectivos<br>";
hace_consulta(
...
echo '<table width="100%">' .
    '<td style="white-space: nowrap; background-color: #CCCCCC;" ' .
    'align="left" valign="top" colspan="2"><b>' .
    '<div align=right><a href="index.php">Men� Principal</a>' .
    '</div></b></td></table>';
