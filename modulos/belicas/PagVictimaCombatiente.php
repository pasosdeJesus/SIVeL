...
/**
 * Pesta�a V�ctima Combatiente de la ficha de captura de caso
 */
...
class PagVictimaCombatiente extends PagBaseMultiple
{
    ...
    var $titulo = 'V�ctima Combatiente';
     ...
     *
     * @param integer $id_combatiente Id  de v�ctima combatiente
     *
    ...
    function procesa(&$valores)
    {
        ...
        if ((!isset($_SESSION['forma_modo'])
            ...
            if (!isset($valores['id_resultado_agresion'])
                ...
                error_valida('Falta resultado de agresi�n', $valores);
                return false;
            }
        }
