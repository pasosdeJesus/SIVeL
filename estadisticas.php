...
/**
 * Estad�sticas victimas individuales/casos
 *
 * PHP version 5
 *
 * @category  SIVeL
...
class AccionEstadisticasInd extends HTML_QuickForm_Action
{
    ...
    function perform(&$page, $actionName)
    {
        ...
        if ($pSegun == 'id_p_responsable') {
            ...
            $cab[] = 'N. V�ctimizaciones';  
            // Una victimizaci�n o violaci�n es un tipo de violencia 
            // sufrido por una v�ctima (sin examinar el o los responsables)
            // Para casos con un s�lo presunto responsable actos y 
            // violaciones/victimizaciones coincide.
            // Un hecho contra una victima con N presuntos responsables, 
            // cuenta como una victimizaci�n pero como N actos
        }
        $tCat .= 'acto';
...
/**
 * Formulario de Estad�sticas Individuales
 *
 * @category SIVeL
 * @package  SIVeL
 * @author   Vladimir T�mara <vtamara@pasosdeJesus.org>
...
class PagEstadisticasInd extends HTML_QuickForm_Page
{
    ...
    function buildForm()
    {
        ...
        $sel->setValue(true);
        $ae[] =& $sel;
        $this->addGroup($ae, null, 'Ubicaci�n', '&nbsp;', false);
