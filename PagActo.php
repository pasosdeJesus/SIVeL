...
/**
 * Pesta�a Actos de la ficha de captura de caso
 */
...
/**
 * Acci�n que responde al boton Agregar agresi�n individual
 *
 * @category SIVeL
 * @package  SIVeL
 * @author   Vladimir T�mara <vtamara@pasosdeJesus.org>
...
/**
 * Acci�n que responde al boton Agregar Agresion colectiva
 *
 * @category SIVeL
 * @package  SIVeL
 * @author   Vladimir T�mara <vtamara@pasosdeJesus.org>
...
/**
 * Acci�n que responde al enlace Eliminar acto individual
 *
 * @category SIVeL
 * @package  SIVeL
 * @author   Vladimir T�mara <vtamara@pasosdeJesus.org>
...
/**
 * Acci�n que responde al enlace Eliminar acto colectivo
 *
 * @category SIVeL
 * @package  SIVeL
 * @author   Vladimir T�mara <vtamara@pasosdeJesus.org>
...
class PagActo extends PagBaseSimple
{
    ...
    function formularioAgrega(&$db, $idcaso)
    {
        ...
        $sel =& $this->createElement('submit', $bn, 'A�adir');
        $gacto[] =& $sel;
     ...
     * @param bool   $procActo    True si y solo si debe a�adirse acto
     * @param bool   $procActocol True si y solo si debe a�adirse acto colec.
     *
    ...
    /**
     * Ver documentaci�n en clase base.
     *
     * @see PagBaseSimple
     *
     * @return void
