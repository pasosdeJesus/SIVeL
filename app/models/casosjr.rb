class Casosjr < ActiveRecord::Base
	has_many :ayudaestado_respuesta, foreign_key: "id_caso", validate: true
	has_many :derecho_respuesta, foreign_key: "id_caso", validate: true
	has_many :ayudasjr_respuesta, foreign_key: "id_caso", validate: true
	has_many :motivosjr_respuesta, foreign_key: "id_caso", validate: true
	has_many :progestado_respuesta, foreign_key: "id_caso", validate: true
