class Actosjr < ActiveRecord::Base
	belongs_to :acto, foreign_key: "id_presponsable,id_persona,id_caso,id_categoria", validate: true
	belongs_to :desplazamiento, foreign_key: "id_caso,fechaexpulsion", validate: true
