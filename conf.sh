...
check "PHP" "" "test -x \$PHP" `which php-7.0 2> /dev/null` `which php-5.6 2> /dev/null` `which php-5.5 2> /dev/null` `php-5.4 2> /dev/null` `which php-5.3 2> /dev/null` `which php-5.2 2> /dev/null` `which php 2> /dev/null` 
