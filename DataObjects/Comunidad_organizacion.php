...
/**
 * Definicion para la tabla comunidad_organizacion.
 */
 ...
 */
class DataObjects_Comunidad_organizacion extends DB_DataObject_SIVeL
{

    var $__table = 'comunidad_organizacion';          // table name
