...
CREATE TABLE aspsicosocial_respuesta (
    id_respuesta integer NOT NULL,
    id_aspsicosocial integer NOT NULL,
...
--
-- Name: causarefugio; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE causarefugio (
    id integer NOT NULL,
...
--
-- Name: causarefugio_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE causarefugio_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: causarefugio_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE causarefugio_id_seq OWNED BY causarefugio.id;
...
ALTER TABLE ONLY causarefugio ALTER COLUMN id SET DEFAULT nextval('causarefugio_id_seq'::regclass);
...
--
-- Name: causarefugio_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY causarefugio
    ADD CONSTRAINT causarefugio_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY municipio
    ADD CONSTRAINT municipio_id_departamento_fkey FOREIGN KEY (id_pais, id_departamento) REFERENCES departamento(id_pais, id);
...
ALTER TABLE ONLY persona
    ADD CONSTRAINT persona_id_departamento_fkey FOREIGN KEY (id_pais, id_departamento) REFERENCES departamento(id_pais, id);
...
ALTER TABLE ONLY persona
    ADD CONSTRAINT persona_id_municipio_fkey FOREIGN KEY (id_pais, id_departamento, id_municipio) REFERENCES municipio(id_pais, id_departamento, id);
...
ALTER TABLE ONLY ubicacion
    ADD CONSTRAINT ubicacion_id_departamento_fkey FOREIGN KEY (id_pais, id_departamento) REFERENCES departamento(id_pais, id);
...
ALTER TABLE ONLY ubicacion
    ADD CONSTRAINT ubicacion_id_municipio_fkey FOREIGN KEY (id_pais, id_departamento, id_municipio) REFERENCES municipio(id_pais, id_departamento, id);
...
INSERT INTO schema_migrations (version) VALUES ('20140317121748');
