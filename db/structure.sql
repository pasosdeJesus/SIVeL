...
--
-- Name: casosjr_id_causaref_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY casosjr
    ADD CONSTRAINT casosjr_id_causaref_fkey FOREIGN KEY (id_causaref) REFERENCES causaref(id);
