...
class ResConsulta
{
     ...
     * @var    array
     */
    var $campos; // Ver par�metros de constructora
    ...
    */
     ...
     *
     * @param integer $idcaso C�digo del caso
     * @param handle  &$db    Conexi�n a base de datos
    ...
    /**
     * Extrae v�ctimas de un caso y retorna su informaci�n en varios
     *   vectores
     *
     * @param integer $idcaso     Id. del caso
     * @param handle  &$db        Conexi�n
     ...
     * @param string $pFinchasta Caja de selecci�n
    ...
    function actosHtml(&$db, $tablas, $donde, $pFinchasta, $pMuestra)
    {
        ...
        if ($pMuestra == "csv") {
            ...
            echo '"Fecha", "Caso", "V�ctima", "Categoria", "P. Responsable", ""\n';
        } elseif ($pMuestra == 'latex') {
            //header("Content-type: application/x-latex");
            echo "<pre>";
            echo '\\textbf{Fecha} & \\textbf{Caso} & \\textbf{V�ctima} & '
                . ' \\textbf{Categoria} & \\textbf{P. Responsable} \\\\ \n '
                . '\hline\n';
        } else { // tabla o consolidado

            echo "<table border='1'>\n";
            echo "<tr><th>Fecha</th><th>Caso</th><th>V�ctima</th>" .
                "<th>Sector Social</th><th>Organizaci�n Social</th>" .
     ...
     * @param object &$db   Conexi�n a BD
     * @param string $q     Q
     * @param string &$sel  Caja de selecci�n
     ...
     *
     * @param boolean $retroalim    Retroalimentaci�n
    ...
    filaTabla($db, $idcaso, $campos, $conv, $sal, $retroalim = true)
    {
        ...
        foreach ($campos as $cc => $nc) {
            ...
            // No se sacaron responsables y dem�s directamente en
            // la consulta por dificultad en el caso de ubicaci�n
            // pues la informaci�n puede provenir de diversas tablas
            if ($cc == 'm_ubicacion') {
     ...
     * La representaci�n en XML de estos relatos es la definida en el
     * documento de dise�o del SINCODH.
     *
     * Ideas:
     * - autocontenido, poner c�digos previamente introducidos.
     *
     * @param integer $idcaso Identificaci�n del caso
     * @param object  $db     conexi�n a base de datos
     * @param array   $campos Campos por mostrar
     * @param boolean $varlin Var�as lineas?
     *
    ...
    static function reporteRelato($idcaso, $db = null,
        ...
        if (!PEAR::isError($nom) && $nom == 'SINCODH:PUBLICO') {
            ...
            // Si no van fuentes se considera p�blico
            $formacomp = 'publico';
        } else {
            $formacomp = 'privado';
        }
        ...
        $max_id_grupo = 0; // M�xima identificaci�n de grupos en v�ctimas
        ...
        if (isset($campos['m_ubicacion'])) {
            ...
            if ($nubi > 1) {
                $arotros['observaciones{tipo->etiqueta:IMPORTA_RELATO}']
                    = date('Y-m-d') . " Tiene m�s de una ubicacion: $uobs";
            }
            $arubicacion = array();
            $dubicacion->aRelato(
                $arubicacion,
        ...
        if (isset($campos['m_fuentes'])
            ...
            //a las personas que dan informaci�n para que el proteja su
            //identidad en el caso de quienes no quieren que sea revelada
            //y para que proteja la vida de quienes optan por visibilizaci�n,
     ...
     * @param array   $campos Campos por mostrar
     * @param boolean $varlin Varias l�neas
     *
    ...
    /**
     * Nombre de una tipificaci�n
     *
     * @param string $c Tipificaci�n
     *
     * @return string Hace peque�os cambios a tipificaci�n que recibe
     */
    ...
    /**
     * Presenta listado de presuntos responsables, categorias y v�ctimas
     *
     * Hay varias formas de agrupar, por ejemplo el siguiente arreglo
     * indexado por presunto responsable y categoria con c�digos de v�ctimas
     * como valor:
     *
     *    Array
        (
    ...
    * Agrupando m�s por presuntos responsables:
    * 15,16 => 10 => i6
    *          12 => i9
    * 15 => 14,19 => i6,i9
    * 16 => 12 => i9
    ...
    * funci�n emplea el siguiente orden:
    ...
    */
    static function listaPrCatVictima($idcaso,  $campos, &$r,
        ...
        /* Categorias que no tiene v�ctimas */
        ...
        foreach ($aspr as $ipr => $imcs) {
            $agC[$ipr][$imcs] = -1; // Convenci�n para Categorias sin v�ctima
        }
     ...
     * @param boolean $numcaso N�mero de caso para orden por r�tulo
     *
    ...
    function reporteRevistaHtml($idcaso, $db = null, $campos = array(),
        ...
        if (array_key_exists('caso_fecha', $campos)) {
            ...
            strftime ... Se intent� pero no soport� locale es */
            if ($tex) {
     ...
     *
     * @param object  $db     Conexi�n
     * @param unknown $idcaso Id. caso
     * @param array   $campos Campos por mostrar
     * @param array   $conv   Para conversi�n de ids.
