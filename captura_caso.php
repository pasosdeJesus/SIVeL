...
/**
 * Ficha para capturar casos (tambi�n utilizable para buscar).
 *
 * PHP version 5
 *
 * @category  SIVeL
...
class CapturaCaso extends HTML_QuickForm_Controller
{
    ...
    /**
     * Agrega botones a una p�gina.
     * Adaptada de Progress/generator.php
     *
     * @param object &$page      HTML_QuicForm_Page p�gina por cambiar
     ...
     *
     * @param object &$page HTML_QuickForm_Page P�gina con ficha.
     *
     * @return void
     */
    ...
    /**
     * Habilita botones est�ndar de la p�gina.
     * Adaptada de Progress/generator.php
     *
     * @param object &$page  HTML_QuickForm_Page P�gina con ficha.
    ...
    /**
     * Deshabilita los botones est�ndar de una p�gina.
     * Adaptada de Progress/generator.php
     *
     * @param object &$page  HTML_QuickForm_Page P�gina con ficha.
     * @param array  $events Eventos
