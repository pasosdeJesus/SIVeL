...
/**
 * Lee men� de base de datos y construye una estructura apropiada para
 * HTML/Menu.
 *
 * @param handle  &$db Conexi�n a base de datos
 * @param integer $id  Identificaci�n de men� por revisar
 *
...
function menu_principal(&$db)
{
    ...
    encabezado_envia(
        ...
        ': ' . 'Sistema de Informaci�n de Violencia Pol�tica'
    );
...
/**
 * Inicializa variables cada vez que llega al �ndice (en particular para
 * b�squedas).
 *
 * @param handle &$db Conexi�n a base de datos
 *
...
function inicializa(&$db)
{
    ...
    if ($idbus <= 0) {
        ...
        die(
            "Variable Global idbus con id. de caso para b�squedas deber�a " .
            "ser no positiva"
        );
    }
}
